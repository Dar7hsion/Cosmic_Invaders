...
//		bullets = new ArrayList();
	...
	public void getHeroImage()
	{
		try {
			...
			R2 = ImageIO.read(getClass().getResourceAsStream("/rocket2.png"));
			R3 = ImageIO.read(getClass().getResourceAsStream("/rocket3.png"));
		}catch(IOException e)
		{
			e.printStackTrace();
		}
	...
	public void draw(Graphics2D g2)
	{
		...
		// rotating the hero, rotation point is the middle of the square
				g2.rotate(getA(), getX() + getW(),
						getY() + getH() / 2);
				// draw the image
				g2.drawImage(getI(), (int) getX(), (int) getY(),
						getW(), getH(), null);
				g2.setTransform(old);
